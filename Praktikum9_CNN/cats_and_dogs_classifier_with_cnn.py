...
if __name__ == "__main__":
    ...
    train_dir, validation_dir, train_cats_dir, train_dogs_dir, \
    train_cat_fnames, train_dog_fnames \
    = load_dataset(zip_file_path, extracted_zip_file_path)
    # Plot the data sets
    plot_cats_and_dogs(train_cats_dir, train_dogs_dir,
    train_cat_fnames, train_dog_fnames)
    # Data preprocessing
    train_generator, validation_generator \
    = do_data_preprocessing(train_dir, validation_dir)
